 ...
 * All reads/writes go through IndexedDB first, then sync to remote in background.
 */

const DB_NAME = '3jes_local_db';
const DB_VERSION = 3;

const STORES = ['installations', 'users', 'historicaldata', 'syncQueue', 'recordSnapshots', 'credentials'] as const;
